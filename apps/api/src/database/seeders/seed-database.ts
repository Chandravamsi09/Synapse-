    ...
    users: [
      {
        ...
        passwordHash: '$2b$12$e8Y...superSecureHashedPassword',
        firstName: 'Alexandra',
        lastName: 'Vance',
        role: 'SUPER_ADMIN',
        isMfaEnabled: true,
      ...
      },
      {
        ...
        passwordHash: '$2b$12$k2L...devHashedPassword',
        firstName: 'David',
        lastName: 'Chen',
        role: 'DEVELOPER',
        isMfaEnabled: false,
    ...
    apiKeys: [
      {
        ...
        hashedSecret: 'sha256:7f83b1657ff1fc53b92dc18148a1d65dfc2d4b1fa3d677284addd200126d9069',
        scopes: ['*'],
    ...
    integrations: [
      {
        ...
        authType: 'OAUTH2',
        credentialsEnc: 'enc_slack_token_xyz',
      ...
      },
      {
        ...
        category: 'PAYMENTS',
        authType: 'API_KEY',
        credentialsEnc: 'enc_stripe_sk_live_xyz',
        healthStatus: 'HEALTHY',
        isActive: true
      },
      {
        ...
        category: 'AI_ML',
        authType: 'BEARER',
        credentialsEnc: 'enc_openai_key_xyz',
        healthStatus: 'HEALTHY',
        isActive: true
      }
    ],
    webhooks: [
      {
        ...
        secretKey: 'whsec_prod_incident_alert_key',
