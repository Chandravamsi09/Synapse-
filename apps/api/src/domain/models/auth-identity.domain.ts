/**
 * Synapse Domain Models: Authentication & Identity
 * High-performance enterprise types, DTOs, and validation logic.
 */

export namespace AuthIdentityDomain {
  ...
  export class UserSessionDTO implements IUserSession {
    id: string = '';
    organizationId: string = '';
    ...
    constructor(init?: Partial<IUserSession>) {
    ...
    sanitizeForClient(): Partial<IUserSession> {
      const clone = { ...this };
  ...
  export class MfaChallengeDTO implements IMfaChallenge {
    ...
    constructor(init?: Partial<IMfaChallenge>) {
      if (init) Object.assign(this, init);
    }
    ...
    sanitizeForClient(): Partial<IMfaChallenge> {
      const clone = { ...this };
      clone.attributes = this.attributes.filter(a => !a.isSecret);
      return clone;
    }
  ...
  export class OAuthCredentialDTO implements IOAuthCredential {
    id: string = '';
    organizationId: string = '';
    createdAt: string = new Date().toISOString();
    updatedAt: string = new Date().toISOString();
    ...
    constructor(init?: Partial<IOAuthCredential>) {
      if (init) Object.assign(this, init);
    }
    ...
    sanitizeForClient(): Partial<IOAuthCredential> {
      const clone = { ...this };
      clone.attributes = this.attributes.filter(a => !a.isSecret);
      return clone;
    }
  ...
  export class SsoConfigDTO implements ISsoConfig {
    ...
    constructor(init?: Partial<ISsoConfig>) {
      if (init) Object.assign(this, init);
    }
    ...
    sanitizeForClient(): Partial<ISsoConfig> {
      const clone = { ...this };
      clone.attributes = this.attributes.filter(a => !a.isSecret);
      return clone;
    }
  ...
  export class PasswordPolicyDTO implements IPasswordPolicy {
    id: string = '';
    organizationId: string = '';
    createdAt: string = new Date().toISOString();
    updatedAt: string = new Date().toISOString();
    ...
    constructor(init?: Partial<IPasswordPolicy>) {
      if (init) Object.assign(this, init);
    }
    ...
    sanitizeForClient(): Partial<IPasswordPolicy> {
      const clone = { ...this };
      clone.attributes = this.attributes.filter(a => !a.isSecret);
      return clone;
    }
  ...
  export class AuditTokenDTO implements IAuditToken {
    id: string = '';
    organizationId: string = '';
    createdAt: string = new Date().toISOString();
    updatedAt: string = new Date().toISOString();
    ...
    constructor(init?: Partial<IAuditToken>) {
      if (init) Object.assign(this, init);
    }
    ...
    sanitizeForClient(): Partial<IAuditToken> {
      const clone = { ...this };
      clone.attributes = this.attributes.filter(a => !a.isSecret);
      return clone;
    }
